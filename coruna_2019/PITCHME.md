...
#### or: how I learned to stop worrying about ERSI Symbols!
<br>
<br>
...
Note:
The customer wants as a result an xml library with the symbols that he can
...
manually. We therefore decided to contribute to the development of this tool
(which was renamed to SLYR) and to finance Nyall to continue its development.
